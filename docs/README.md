...
| 6а | [`roadmap-ui.md`](roadmap-ui.md) | 2 — канон | 🟢 действующий | сведённый UI-роадмап: этапы A–H поверх фаз 3–10 со всеми поправками (D-33, D-44…D-52), клик-бюджеты в DoD |
| 6б | [`ui-concept.md`](ui-concept.md) | 2 — канон | 🟡 на оценке | описание концепции интерфейса для пользователя: П-1…П-24 принципы, Ш-1…Ш-7 шероховатости — база для правок |
